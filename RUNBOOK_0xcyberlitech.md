...
<!-- Mis à jour : 2026-05-14 — Chantier dette technique : git initialisé + pre-commit hooks + ruff.toml + CSS 8 fichiers + audio_dsp.py · 31 modules Python · jarvis.py 4633L · score honnête 78/100 -->
