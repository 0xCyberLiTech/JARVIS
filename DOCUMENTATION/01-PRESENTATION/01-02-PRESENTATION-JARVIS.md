...
<!-- 0xCyberLiTech · v3.3 · 2026-06-09 — agent persistant Hermès (5 briques) · routing 4 branches · phi4:14b + qwen3:8b CR + gemma4 + qwen2.5-coder + mxbai-embed · RAG ~1700 chunks warmup boot · 39 tests E2E Playwright · ESLint 0 · MCP 12 outils · proc_guard.py cycle de vie · métriques courantes → BILAN-TECHNIQUE.md §0 -->
