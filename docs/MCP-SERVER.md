...
Puis redémarre Claude Desktop. Les 12 outils apparaissent sous "jarvis" dans le menu MCP de Claude.

**Vérification :**
- `http://localhost:5010/health` → devrait retourner `{"status": "ok"}`
- Dans Claude Desktop, demander : "list les outils MCP disponibles" — les 12 outils `jarvis_*` doivent apparaître
